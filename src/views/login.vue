      ...
      <div class="bg-gray-100 rounded-b-lg py-12 px-4 lg:px-24">
        ...
        <form @submit.prevent="userSignup" class="mt-6">
          ...
          <div class="flex items-center justify-center mt-8">
            <button
              class="text-white py-2 px-4 uppercase rounded bg-primary hover:bg-primary shadow hover:shadow-lg font-medium transition transform hover:-translate-y-0.5"
            >
              Create Account
            </button>
          </div>
